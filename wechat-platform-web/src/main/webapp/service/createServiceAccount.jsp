...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script type="text/javascript">
    	$(function() {
    		$("#new_service_account_cancel").click(function() {
    			var ss = $("#ifrm-popup-content", parent.document).dialog("height");
    			alert(ss);
    			//$(this).dialog("close");
    			//$("#ifrm-popup-content", window.parent.document).dialog("close");
    			//top.dlg_close();
    		});
    	});
    </script>
  ...
  <body>
    ...
    <form:form id="frmCreateServiceAccount" action="createServiceAccount.do" method="POST" cssStyle="width:100%" commandName="serviceAccountModel">
	  ...
	  <div style="top:20px; border:0px solid #333">
        ...
        <form:input path="accountName" maxlength="100"/><br/><br/>
        <spring:message code="wechat.service.account.desc"/>:&nbsp;
        <form:textarea path="accountDesc" maxlength="1024"/><br/><br/>
