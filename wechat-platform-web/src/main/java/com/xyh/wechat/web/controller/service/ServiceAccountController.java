...
public class ServiceAccountController {
	...
	public void initQueryServiceAccountForm(ModelMap model) {
		ServiceAccountCriteriaModel queryModel = new ServiceAccountCriteriaModel();
	...
	public ModelAndView postQueryServiceAccountForm(HttpSession httpSession, @ModelAttribute("serviceAccountCriteriaModel") ServiceAccountCriteriaModel queryModel, BindingResult result, ModelMap model) {
	...
	private void queryServiceAccount(ServiceAccountCriteriaModel queryModel, ModelMap model, ModelAndView mv) {
		...
		model.addAttribute("serviceAccountCriteriaModel", queryModel);
	}
