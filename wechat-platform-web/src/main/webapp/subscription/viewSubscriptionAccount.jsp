...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body style="overflow:hidden">
    <div class="container-fluid" style="margin-left:0px;">
      <form:form id="frmUpdateSubscriptionAccount" action="viewSubscriptionAccount.do" method="POST" cssStyle="width:100%" commandName="subscriptionAccountModel">
          ...
          <div class="row" style="margin-top:10px;">
            <div class="col-md-12 controls">
              <div class="form-group">
	            ...
	            <a href="${pageContext.request.contextPath}/platform/updateSubscriptionAccount.do?id=${subscriptionAccountModel.id}" class="btn btn-success">&nbsp;&nbsp;&nbsp;&nbsp;<spring:message code="button.update"/>&nbsp;&nbsp;&nbsp;&nbsp;</a>
