...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body style="overflow:hidden">
    <div class="container-fluid" style="margin-left:0px;">
      <form:form id="frmCreatePlatformRole" action="createPlatformRole.do" method="POST" class="form-inline" commandName="platformUserRole">
        <div class="form-inline">
          ...
          <div class="row" style="margin-top:10px;">
            <div class="col-md-12 controls">
              <div class="form-group">
                <a href="#" onclick="$('#frmCreatePlatformRole').submit();" class="btn btn-success">&nbsp;&nbsp;&nbsp;&nbsp;<spring:message code="button.create"/>&nbsp;&nbsp;&nbsp;&nbsp;</a>
