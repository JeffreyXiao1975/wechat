...
public class WeChatPlatformPageUtil {
	public static final String ASC = "asc"; 
	   ...
	   */
	  public static WeChatPlatformPage inintPage(Long totalCount,Integer index,String value,WeChatPlatformPage sessionPage){  
		 WeChatPlatformPage page = null; 
	    if(index < 0){ 
	       page = new WeChatPlatformPage(totalCount); 
	    }else{ 
	       /**每页显示多少条*/
	   ...
	   */
	  public static WeChatPlatformPage execPage(int index,String value,WeChatPlatformPage sessionPage){  
		  WeChatPlatformPage page = sessionPage;       
	    /**调用方法进行分页计算*/
