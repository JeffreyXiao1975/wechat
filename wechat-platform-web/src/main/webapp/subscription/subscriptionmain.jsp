                        ...
                        <div class="accountmenu">
                          <ul>
                            <li>
                              ...
                              <ul>
                                <li><a href="#" onclick="openlayer('${pageContext.request.contextPath}/subscription/viewSubscriptionAccount.do?id='+'${subscriptionAccountVo.id}', 2, '<spring:message code="wechat.subscription.account"/>', '500px', '300px');">&nbsp;<spring:message code="button.view"/></a></li>
                                <li><a href="#" onclick="openlayer('${pageContext.request.contextPath}/subscription/updateSubscriptionAccount.do?id='+'${subscriptionAccountVo.id}', 2, '<spring:message code="wechat.subscription.account"/>', '500px', '300px');">&nbsp;<spring:message code="button.update"/></a></li>
                                <li><a href="#" onclick="disableaccount('${subscriptionAccountVo.id}');">&nbsp;<spring:message code="button.disable"/></a></li>
                                <li><a href="#" onclick="deleteaccount(${subscriptionAccountVo.id});">&nbsp;<spring:message code="button.delete"/></a></li>
                              </ul>
                            </li>
                          </ul>
                        </div>
                        ...
                        <div class="accountmenu">
                          <ul>
                            <li>
                              ...
                              <ul>
                                <li><a href="#" onclick="openlayer('${pageContext.request.contextPath}/subscription/viewSubscriptionAccount.do?id='+'${subscriptionAccountVo.id}', 2, '<spring:message code="wechat.subscription.account"/>', '500px', '300px');">&nbsp;<spring:message code="button.view"/></a></li>
                                <li><a href="#" onclick="enableaccount('${subscriptionAccountVo.id}');">&nbsp;<spring:message code="button.enable"/></a></li>
                                <li><a href="#" onclick="deleteaccount(${subscriptionAccountVo.id});">&nbsp;<spring:message code="button.delete"/></a></li>
                              </ul>
                            </li>
                          </ul>
