...
import com.xyh.wechat.web.model.subscription.QuerySubscriptionAccountCriteriaModel;
...
public class SubscriptionController extends BaseController {
	...
	public void initSubscriptionAccountForm(ModelMap model) {
		QuerySubscriptionAccountCriteriaModel queryModel = new QuerySubscriptionAccountCriteriaModel();
	...
	public ModelAndView postSubscriptionAccountForm(HttpSession httpSession, @ModelAttribute("querySubscriptionAccountCriteriaModel") @Valid QuerySubscriptionAccountCriteriaModel queryModel, BindingResult result, ModelMap model) {
	...
	private void querySubscriptionAccount(QuerySubscriptionAccountCriteriaModel queryModel, ModelMap model, ModelAndView mv) {
		...
		model.addAttribute("querySubscriptionAccountCriteriaModel", queryModel);
	}
}
