      ...
      <form:form id="frmUpdatePlatformUser" action="updatePlatformUser.do" method="POST" class="form-inline" commandName="platformUserModel">
        <div class="form-inline">
          ...
          <div class="row" style="margin-top:10px;">
            <div class="col-md-12 controls">
              <div class="form-group">
                <a href="${pageContext.request.contextPath}/platform/updatePlatformUser.do?id=${platformUserModel.id}" class="btn btn-success">&nbsp;&nbsp;&nbsp;&nbsp;<spring:message code="button.update"/>&nbsp;&nbsp;&nbsp;&nbsp;</a>
